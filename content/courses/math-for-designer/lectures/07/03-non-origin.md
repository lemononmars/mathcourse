...
Let $P_1(x_1, y_1)$ and $P_2(x_2, y_2)$ be points on the plane. A vector starting at $P_1$ and ending at $P_2$ is denoted by $\vec{P_1P_2}$ which can be computed as follows.
\begin{equation}
