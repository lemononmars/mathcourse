...
$f: A \rightarrow B$ เป็นฟังก์ชันหนึ่งต่อหนึ่ง ก็ต่อเมื่อ ไม่มีคู่อันดับที่สมาชิกตัวหลังเหมือนกัน **แต่สมาชิกตัวหน้าต่างกัน**
...
- กำหนดตัวแปร $y$ โดยที่ $y = f(x)$ \pa

- สลับตัวแปรใหม่ ให้อยู่ในรูป $x = f(y)$ \pa

- จัดรูปสมการให้ฝั่งซ้ายมี $y$ พจน์เดียว และฝั่งขวามีพจน์ $x$ และค่าคงตัวทั้งหมด \pa
...
- ขั้นแรกกำหนดตัวแปร $y = f(x)$ ขึ้นมาใหม่ \pa จะได้ 
\[y = x+2\] \pa

- จากนั้นสลับตัวแปรใหม่จะได้เป็น \pa
\[x = y+2\] \pa

- จัดรูปให้ $y$ อยู่ฝั่งซ้าย \pa จะได้
\[y = x-2\] \pa 
